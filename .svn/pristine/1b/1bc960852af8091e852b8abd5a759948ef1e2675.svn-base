...
public class GraphicsWrapper extends View {
	...
	public void addImage() {
		Bitmap wallpaint = BitmapFactory.decodeResource(con.getResources(), 0x7f02004d);  
		BitmapShader fillBMPshader = new BitmapShader(wallpaint, TileMode.REPEAT, TileMode.REPEAT);
        col.setColor(0xFFFFFFFF);  
        col.setStyle(Paint.Style.FILL);   
        col.setShader(fillBMPshader); 
	}
