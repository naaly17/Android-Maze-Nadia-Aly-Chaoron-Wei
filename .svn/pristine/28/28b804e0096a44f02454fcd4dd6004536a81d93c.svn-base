 ...
 */
public class MazeBuilder implements Runnable, Serializable{
	...
	public int startx ; // starting position inside maze for entity to search for exit
	public int starty;
	...
	public void run() {
		...
		try {
			...
			//System.out.println(dists.height);
