...
public interface Viewer {
	 ...
	 * 
	 * @param graphics graphics handler for the buffer image that this class draws on
	 ...
	 */
	public void redraw(GraphicsWrapper graphics, int state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang) ;
	
	public void redraw(GraphicsWrapper gc, int state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang, int pathlength, int energy) ;
	/** 
