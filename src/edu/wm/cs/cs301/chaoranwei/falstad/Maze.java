...
// MEMO: original code: public class Maze extends Applet {
	...
	public GraphicsWrapper panel ; // graphics to draw on, shared by all views
	...
	public int walkStep;
	public int viewdx; // current view direction
	public int viewdy;
	public int endx, endy;
	public FirstPersonDrawer f;
	...
	public int method = 0 ; // 0 : default method, Falstad's original code
	...
	public Maze(int method)
	{
		...
		if (1 == method)
			...
			this.method = 2;
		//panel = new GraphicsWrapper(null, null, 0) ;
	}
	/**
	 ...
	 */
	public void build(int skill, int method) {
		// switch screen
	    skill_level = skill;
	...
	public void newMaze(BSPNode root, Cells c, Distance dists, int startx, int starty) {
		...
		if (mazebuilder != null) {
			endx = mazebuilder.endx;
			endy = mazebuilder.endy;
		}
		//robot = new BasicRobot(this);
	    //driver.setRobot(robot);
		//System.out.println(maze.mazedists.height);
	...
	public Thread getBuilderThread() {
		// TODO Auto-generated method stub
		return mazebuilder.buildThread;
	}
	...
	public void addViews() {
		f = new FirstPersonDrawer(Constants.VIEW_WIDTH,Constants.VIEW_HEIGHT,
